...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public void put(Bitmap bitmap) {
        int size = Utils.getBitmapByteSize(bitmap);
    ...
    public Bitmap get(int width, int height, Bitmap.Config config) {
        int size = Utils.getBitmapByteSize(width, height, config);
        ...
        if (result != null) {
            ...
            decrementBitmapOfSize(Utils.getBitmapByteSize(result), result.getConfig());
    ...
    public Bitmap removeLast() {
        ...
        if (removed != null) {
            int removedSize = Utils.getBitmapByteSize(removed);
    ...
    public int getSize(Bitmap bitmap) {
        return Utils.getBitmapByteSize(bitmap);
    }
