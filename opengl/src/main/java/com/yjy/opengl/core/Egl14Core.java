 ...
 */
@TargetApi(17)
public class Egl14Core  implements IEGLCore{
    ...
    private static final String TAG = Egl14Core.class.getSimpleName();
    ...
    public Egl14Core(@EGLVersion int eglVersion) {
    ...
    public void initialize(@NonNull Surface surface) {
        initializeInternal(surface, EGL14.EGL_NO_CONTEXT);
    }
    ...
    public void initialize(@NonNull SurfaceTexture surfaceTexture) {
        initializeInternal(surfaceTexture,  EGL14.EGL_NO_CONTEXT);
    }
